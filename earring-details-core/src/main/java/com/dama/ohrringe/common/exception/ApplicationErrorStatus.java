...
public enum ApplicationErrorStatus {
  ...
  ENTITY_ALREADY_EXIST(Status.BAD_REQUEST, "%s with  id %s has already existed in database"),
  USER_ALREADY_EXIST(Status.BAD_REQUEST, "%s with login %s has already existed in database"),
  ENTITY_NOT_FOUND(Status.BAD_REQUEST, "%s with id %s not found in database"),
  EMAIL_ALREADY_EXIST(Status.BAD_REQUEST, "%s with email %s has already existed in database");
